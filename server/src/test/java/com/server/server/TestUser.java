...
public class TestUser {
    ...
    void testGetAllUsers() {
        ...
        User user2 = new User("iAmUser2", "BVuyra;tlymss1", UserType.USER, "truth@outlook.com");
        User user3 = new User("iAmUser3", "Klktlkynva!100", UserType.USER, "testers@somekindofmail.com");
        ...
        Assertions.assertEquals(UserType.USER, users.get(1).getUserType());
        Assertions.assertEquals(UserType.USER, users.get(2).getUserType());
    ...
    void testUpdateUser() {
        ...
        User existingUser = new User("oldUsername", "Xhajk10#$", UserType.USER, "old@email.com");
    ...
    void testDeleteUser() {
        ...
        User existingUser = new User("existingUser", "Ajhjtjt150!9aG", UserType.USER, "realEmail@gmail.com");
